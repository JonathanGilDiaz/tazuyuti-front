...
import { PrecioPaqueteriaEditComponent } from '../precio-paqueteria-edit/precio-paqueteria-edit.component';
import { PrecioPaqueteriaAddComponent } from '../precio-paqueteria-add/precio-paqueteria-add.component';
...
@Component({
  ...
  templateUrl: './precio-paqueteria-list.component.html',
  styleUrl: './precio-paqueteria-list.component.css',
})
export class PrecioPaqueteriaListComponent {
  datos: PrecioPaqueteria[] = [];
  ...
  editar(precio: PrecioPaqueteria) {
    this.mostrarModalAdicional(PrecioPaqueteriaEditComponent, 'Editar precio', {
      precio,
    });
