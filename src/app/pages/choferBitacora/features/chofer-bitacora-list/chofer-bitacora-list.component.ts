...
@Component({
  ...
  templateUrl: './chofer-bitacora-list.component.html',
  styleUrl: './chofer-bitacora-list.component.css',
})
export class ChoferBitacoraListComponent {
  datos: DetalleRuta[] = [];
  ...
  obtenerDatos(dataTablesParams: DataTableParams) {
    this.service
      .obtenerRegistrosChofer(this.authService.getUsuario()?.id, dataTablesParams)
