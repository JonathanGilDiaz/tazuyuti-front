...
@Component({
  ...
  imports: [ CommonModule,
    ...
    ReactiveFormsModule,
    DropdownModule,],
  templateUrl: './precio-paqueteria-add.component.html',
  styleUrl: './precio-paqueteria-add.component.css',
})
export class PrecioPaqueteriaAddComponent implements OnInit {
  form: FormGroup;
